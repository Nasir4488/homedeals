        ...
        child: StaggeredGrid.count(
          ...
          children:  [
            StaggeredGridTile.count(
              ...
              child: Container(
                  child: Column(
                    ...
                    children: [
                      AutoSizeText("Comercial",style: mediamheading,),
            ...
            StaggeredGridTile.count(
              crossAxisCellCount: 2,
              mainAxisCellCount: 1.5,
              child: CustomProperty(image: images[2],title: comercial[1],),
            ),
            StaggeredGridTile.count(
              crossAxisCellCount: 2,
              mainAxisCellCount: 1.5,
              child: CustomProperty(image: images[1],title: comercial[2],),
            ),
            StaggeredGridTile.count(
              crossAxisCellCount: 2,
              mainAxisCellCount: 1.5,
              child: CustomProperty(image: images[0],title: comercial[3],),
            ),

            StaggeredGridTile.count(
              crossAxisCellCount: 2,
              mainAxisCellCount: 1.5,
              child: CustomProperty(image: images[0],title: comercial[4],),
            ),
            StaggeredGridTile.count(
              crossAxisCellCount: 2,
              mainAxisCellCount: 1.5,
              child: CustomProperty(image: images[0],title: comercial[5],),
            ),
...
class CustomProperty extends StatefulWidget {
  final String image;
  final String title;
  CustomProperty({Key? key,required this.image,required this.title}) : super(key: key);
