    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AutoSizeText(
            "Thanks for be the part of it.",
            style: Theme.of(context).textTheme.bodyMedium!,
          ),
          SizedBox(height: 60),

          FutureBuilder(
              future: finestPeoperties.searchProperties({"sort":"-listingDate","userid":"${auth.currentUser!.uid}"}),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //   ),
                      // ),
                      SizedBox(height: 10), // Added spacing between 'Featured' and other content
                      Row(
                        children: [
                          Container(
